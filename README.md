# BrockyouAPI
An API that can be used to check if a password has been leaked
...
cd pwa/src/public
"><pre><code> https://goodquestion.tech:8443/brockyou/api/v2/{yourpassword}
</code></pre></div>
...
<p><i>true</i> if the given password has been leaked, <i>false</i> otherwise.</p>  
